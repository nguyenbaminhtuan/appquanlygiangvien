            ...
            <form method="POST" action="{{ route('academic-years.update', $academicYear->id) }}">
                ...
                <div>
                    ...
                    <input id="name" class="block mt-1 w-full rounded-md shadow-sm"
                           type="text" name="name" value="{{ old('name', $academicYear->name) }}" required autofocus />
                </div>
                ...
                <div class="mt-4">
                    ...
                    <input id="start_date" class="block mt-1 w-full rounded-md shadow-sm"
                           type="date" name="start_date" value="{{ old('start_date', $academicYear->start_date->format('Y-m-d')) }}" required />
                </div>
                ...
                <div class="mt-4">
                    ...
                    <input id="end_date" class="block mt-1 w-full rounded-md shadow-sm"
                           type="date" name="end_date" value="{{ old('end_date', $academicYear->end_date->format('Y-m-d')) }}" required />
                </div>

                <div class="flex items-center justify-end mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                    <a href="{{ route('academic-years.index') }}" class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md">
                        {{ __('Hủy') }}
                    </a>
                    <button type="submit"
